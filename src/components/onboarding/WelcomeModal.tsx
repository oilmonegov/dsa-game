  ...
  const steps = [
    {
      ...
      description:
        'Master Data Structures and Algorithms through interactive challenges and games.',
    ...
    },
    {
      ...
      description:
        'Complete quizzes, solve traversal challenges, match real-world applications, and fill in code blanks.',
    ...
    >
      <div className="text-center py-4">
        ...
        <div className="flex justify-center mb-4 animate-bounce-in">
          <div
            className={`p-4 rounded-2xl bg-gradient-to-br ${currentStepData.color} bg-opacity-10`}
          >
        ...
        <p className="text-gray-600 mb-8 animate-fade-in">{currentStepData.description}</p>
