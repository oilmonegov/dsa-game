      ...
      <CardHeader gradient={gradient}>
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            {difficulty && <Badge variant={difficultyVariants[difficulty]}>{difficulty}</Badge>}
...
export function ChallengeResult({ isCorrect, explanation, correctAnswer }: ChallengeResultProps) {
  return (
    <div
      className={`
        p-6 border-t
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          {explanation && <p className="text-sm opacity-90 mb-3">{explanation}</p>}
